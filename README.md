...
- [developing-today-forks/terraform-plugin-log-tflog-slog-handler](https://github.com/developing-today-forks/terraform-plugin-log-tflog-slog-handler) -  (4 days ago)
...
- [oils-for-unix/oils](https://github.com/oils-for-unix/oils) - Oils is our upgrade path from bash to a better language and runtime.  It&#39;s also for Python and JavaScript users who avoid shell! (2 months ago)
