...
- [samber/do](https://github.com/samber/do) ([v2.0.0-beta.7](https://github.com/samber/do/releases/tag/v2.0.0-beta.7), 1 week ago) - ⚙️  A dependency injection toolkit based on Go 1.18&#43; Generics.
...
- [peter-evans/create-pull-request](https://github.com/peter-evans/create-pull-request) ([v6.0.5](https://github.com/peter-evans/create-pull-request/releases/tag/v6.0.5), 4 weeks ago) - A GitHub action to create a pull request for changes to your repository in the actions workspace
