...
- [sakshatshinde/hyprcursor-themes](https://github.com/sakshatshinde/hyprcursor-themes) - A list of publicly available hyprcursor themes (1 month ago)
...
- [gowebly/gowebly](https://github.com/gowebly/gowebly) ([v2.7.1](https://github.com/gowebly/gowebly/releases/tag/v2.7.1), 4 days ago) - 🔥 A next-generation CLI tool that makes it easy to create amazing web applications with Go on the backend, using htmx, hyperscript or Alpine.js, and the most popular CSS frameworks on the frontend.
