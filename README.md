...
- [sindresorhus/string-length](https://github.com/sindresorhus/string-length) ([v5.0.0](https://github.com/sindresorhus/string-length/releases/tag/v5.0.0), 1 month ago) - Get the real length of a string - by correctly counting astral symbols and ignoring ansi escape codes
