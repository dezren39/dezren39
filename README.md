...
- [srid/emanote-template](https://github.com/srid/emanote-template) - Notebook template for Emanote (1 day ago)
- [developing-today/zettel](https://github.com/developing-today/zettel) -  (1 day ago)
- [dezren39/zettel](https://github.com/dezren39/zettel) -  (2 days ago)
- [developing-today-forks/terraform-plugin-log-tflog-slog-handler](https://github.com/developing-today-forks/terraform-plugin-log-tflog-slog-handler) -  (1 week ago)
...
- [charmbracelet/wish](https://github.com/charmbracelet/wish) ([v1.4.2](https://github.com/charmbracelet/wish/releases/tag/v1.4.2), 6 days ago) - Make SSH apps, just like that! 💫
