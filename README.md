...
- [automerge/automerge-swift](https://github.com/automerge/automerge-swift) - Swift language bindings presenting Automerge (9 months ago)
...
- [manaflow-ai/cmux](https://github.com/manaflow-ai/cmux) ([rc](https://github.com/manaflow-ai/cmux/releases/tag/rc), 1 day ago) - Open source Ghostty-based macOS terminal with vertical tabs and notifications for AI coding agents. Built for multitasking, organization, and programmability.
- [vtemian/octto](https://github.com/vtemian/octto) ([v0.4.4](https://github.com/vtemian/octto/releases/tag/v0.4.4), 1 week ago) - Interactive brainstorming UI for OpenCode agents - multi-question forms, decisions, and real-time feedback
