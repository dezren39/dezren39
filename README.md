...
- [piraeusdatastore/piraeus-operator](https://github.com/piraeusdatastore/piraeus-operator) ([v2.10.0](https://github.com/piraeusdatastore/piraeus-operator/releases/tag/v2.10.0), 1 day ago) - The Piraeus Operator manages LINSTOR clusters in Kubernetes.
- [mrshmllow/affinity-nix](https://github.com/mrshmllow/affinity-nix) ([affinity-v3](https://github.com/mrshmllow/affinity-nix/releases/tag/affinity-v3), 6 days ago) - Affinity v3 &amp; v2 packaged with Nix!
