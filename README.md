...
- [samber/do](https://github.com/samber/do) ([v2.0.0-beta.6](https://github.com/samber/do/releases/tag/v2.0.0-beta.6), 3 days ago) - ⚙️  A dependency injection toolkit based on Go 1.18&#43; Generics.
- [gowebly/gowebly](https://github.com/gowebly/gowebly) ([v2.5.0](https://github.com/gowebly/gowebly/releases/tag/v2.5.0), 5 days ago) - 🔥 A next-generation CLI tool that makes it easy to create amazing web applications with Go on the backend, using htmx, hyperscript or Alpine.js, and the most popular CSS frameworks on the frontend.
