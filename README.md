...
- [rohoswagger/ez-stack](https://github.com/rohoswagger/ez-stack) ([v0.3.4](https://github.com/rohoswagger/ez-stack/releases/tag/v0.3.4), 3 days ago) - The Stacked PR CLI for agents - Manage worktrees, atomic PRs, and more all from the CLI
